...
var USER_INDEX = (function () {
    ...
    function loadClientCard(clientCard) {
        ...
        $(".editable-form #company").editable("destroy").empty();
        $(".editable-form #client").editable("destroy").empty();
        $(".editable-form #phoneNumber").editable("destroy");
        $(".editable-form #status").editable("destroy").empty();
        $(".editable-form #area").editable("destroy").empty();
        $(".editable-form #district").editable("destroy");
        $(".editable-form #adress").editable("destroy");
        $(".editable-form #info").editable("destroy").empty();
        $(".editable-form #talkresult").editable("destroy").empty();

        $(".editable-form #company").editable({
            type: 'text',
            inputclass: "input-name-class ",
            pk: 1,
            value: 'АГРО',
     //       value: clientCard.client.company,
        ...
        $(".editable-form #client").editable({
            type: 'text',
            inputclass: "input-name-class ",
            pk: 1,
            value: 'Секретарь (АЛИНА)',
     //       value: clientCard.client.company,
            title: 'Введите название компании',
            mode: 'inline',
            validate: function (value) {
        ...
        $(".editable-form #headname").editable({
            type: 'text',
            inputclass: "input-name-class ",
            pk: 1,
            value: 'Иванов Петр Николаевич',
     //       value: clientCard.client.company,
            title: 'Введите имя руководителя',
            mode: 'inline',
            validate: function (value) {
                if ($.trim(value) == '') {
                    return 'Это обязательное поле';
         ...
         $(".editable-form #engineername").editable({
            type: 'text',
            inputclass: "input-name-class ",
            pk: 1,
            value: 'Инженеров Александр Александрович',
     //       value: clientCard.client.company,
            title: 'Введите имя инженера',
            mode: 'inline',
            validate: function (value) {
                if ($.trim(value) == '') {
                    return 'Это обязательное поле';
            ...
            $(".editable-form #additionalcontact").editable({
            type: 'text',
            inputclass: "input-name-class ",
            pk: 1,
            value: 'Помощник руководителя Татьяна',
     //       value: clientCard.client.company,
            title: 'Введите доп. контакт',
            mode: 'inline',
            validate: function (value) {
                if ($.trim(value) == '') {
                    return 'Это обязательное поле';
    ...
    //    value: clientCard.client.phoneNumber,
         ...
         $(".editable-form #headnumber").editable({
            type: 'text',
            pk: 1,
            disabled: false,
            value: '380989235534',
    //    value: clientCard.client.phoneNumber,
            ...
            display: function (value) {
                ...
                $('#btnPhoneNum').unbind('click').click(function () {
                  ...
                  $(".editable-form #engineernumber").editable({
            type: 'text',
            pk: 1,
            disabled: false,
            value: '3806764532343',
    //    value: clientCard.client.phoneNumber,
            ...
            display: function (value) {
                ...
                $('#btnPhoneNum').unbind('click').click(function () {
                 ...
                 $(".editable-form #additionalnumber").editable({
            type: 'text',
            pk: 1,
            disabled: false,
            value: '3805046543993',
    ...
    //    value: clientCard.client.phoneNumber,
         ...
         $(".editable-form #district").editable({
            type: 'text',
            pk: 1,
            disabled: false,
            value: 'Царичанский',
    //    value: clientCard.client.phoneNumber,
        ...
        $(".editable-form #adress").editable({
            type: 'text',
            pk: 1,
            disabled: false,
            value: 'c. Царичанка, ул. Шевченко, 35',
    //    value: clientCard.client.phoneNumber,
            title: 'Укажите адрес',
            showbuttons: 'false',
            mode: 'inline',
      ...
      $(".editable-form #status").editable({
        ...
        $(".editable-form #talkresult").editable({
            type: 'textarea',
            placeholder: "Ваш комментарий...",
            pk: 1,
            mode: 'inline',
